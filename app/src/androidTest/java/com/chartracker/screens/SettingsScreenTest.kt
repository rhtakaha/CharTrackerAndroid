    ...
    fun setupSettingsScreen(){
        ...
        composeTestRule.setContent {
            SettingsScreen(
                ...
                onUpdatedEmailChange = {new -> updateEmail.value = new},
                submitUpdatedEmail = {},
                updatedPassword = updatePassword.value,
                onUpdatedPasswordChange = {new -> updatePassword.value = new},
                submitUpdatedPassword = {},
                confirmedPassword = confirmedPassword.value,
                onConfirmedPasswordChange = {new -> confirmedPassword.value = new},
                signOut = { /**/ },
